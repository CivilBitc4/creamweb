!(function (factory) {
  "function" == typeof define && define.amd
    ...
    : (window.scrollme = factory(jQuery));
})(function ($) {
  var _this = {},
    $document = $(document),
    $window = $(window);
  return (
    ...
    (_this.easing_functions = {
      ...
      easeinout: function (x) {
        return x < 0.5 ? 4 * x * x * x : 1 - 4 * (x = 1 - x) * x * x;
      },
    }),
    (_this.init_events = [
      "load",
    ...
    (_this.animate = function () {
      for (
        var elements_in_view_length = _this.elements_in_view.length, i = 0;
        i < elements_in_view_length;
        i++
      )
        for (
          var element = _this.elements_in_view[i],
            effects_length = element.effects.length,
            e = 0;
          e < effects_length;
          e++
        ) {
          if ("vertical" == _this.direction) {
            ...
            effect.crop &&
              (start < 0 && (start = 0),
              end > _this.body_width - _this.viewport_width &&
                (end = _this.body_width - _this.viewport_width));
          ...
          var from = effect.from,
            ...
            translatey = _this.animate_value(
              scroll,
              scroll_eased,
              from,
              to,
            ...
            translatex = _this.animate_value(
              scroll,
              scroll_eased,
              from,
              to,
            ...
            translatez = _this.animate_value(
              scroll,
              scroll_eased,
              from,
              to,
    ...
    (_this.animate_value = function (
      ...
      if (
        ("opacity" == property &&
          "startopacity" in effect.properties &&
          (value_default = effect.properties.startopacity),
        !(property in effect.properties))
      )
        return value_default;
      var value_target = effect.properties[property],
        forwards = to > from,
        percentages =
          property.indexOf("translate") >= 0 &&
          "string" == typeof value_target &&
          "%" == value_target.charAt(value_target.length - 1),
        translate_unit = "px";
      if (
        (percentages &&
          ((value_target = parseFloat(value_target.slice(0, -1), 10)),
          (translate_unit = "%")),
        scroll < from && forwards)
      )
        return value_default;
      ...
      switch (property) {
        ...
        case "translatey":
        case "translatez":
          new_value = new_value.toFixed(0) + translate_unit;
          break;
        case "rotatex":
        case "rotatey":
        case "rotatez":
          new_value = new_value.toFixed(1) + "deg";
          break;
        case "scale":
    ...
    (_this.update_elements_in_view = function () {
      _this.elements_in_view = [];
      for (
        var elements_length = _this.elements.length, i = 0;
        i < elements_length;
        i++
      )
        "vertical" == _this.direction
    ...
    (_this.update_element_sizes = function () {
      for (
        ...
        var element_height = _this.elements[i].element.outerHeight(),
          element_width = _this.elements[i].element.outerWidth(),
    ...
    (_this.destroy_elements = function () {
      for (
        var elements_length = _this.elements.length, i = 0;
        i < elements_length;
        i++
        ...
        for (
          var effect_length = _this.elements[i].effects.length, j = 0;
          j < effect_length;
          j++
        )
          _this.elements[i].effects[j].element.css({
            opacity: "",
            transform: "",
          });
        (_this.elements[i].effects = []),
          _this.elements[i].element.removeClass("scrollme--before"),
          _this.elements[i].element.removeClass("scrollme--active"),
          _this.elements[i].element.removeClass("scrollme--complete");
      }
      (_this.elements = []), (_this.elements_in_view = []);
    }),
    _this
  );
});
